...
Si lo prefiere, lance codeblocks y abra el archivo elim-rango.cbp.
Hay 2 perfiles de ejecución para probar su tarea:
+ Debug (equivale a make run-g)
+ Sanitize (make run-san)

Ud. debe programar la funcion solicitada en el archivo elim-rango.c.
...
archivo elim-rango.zip que contiene elim-rango.c, con su solución,
...
Entregue por U-cursos el archivo elim-rango.zip
