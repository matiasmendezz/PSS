...
Ud. debe programar su solución en el archivo consultar.c.
...
archivo consultar.zip que contiene consultar.c, con su solución,
...
Si prefiere codeblocs, láncelo y abra el archivo consultar.cbp.
Hay 3 perfiles de ejecución para probar su tarea:
+ Debug (equivale a make run-g)
+ Sanitize (make run-san)
+ Release (make run)

Solo prueba para el caso ./consultar.bin dicc.txt perro
...
en el panel Program arguments.  Por ejemplo: dicc.txt techo
...
Entregue por U-cursos el archivo consultar.zip
